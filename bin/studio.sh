...
if [ -z "$JRE" ] && [ -s "${CONFIG_HOME}/Google/AndroidStudio2026.1.4/studio.jdk" ]; then
  USER_JRE=$(cat "${CONFIG_HOME}/Google/AndroidStudio2026.1.4/studio.jdk")
...
# shellcheck disable=SC2034
IDE_CACHE_DIR="${XDG_CACHE_HOME:-${HOME}/.cache}/Google/AndroidStudio2026.1.4"
...
elif [ -r "${CONFIG_HOME}/Google/AndroidStudio2026.1.4/studio64.vmoptions" ]; then
  USER_VM_OPTIONS_FILE="${CONFIG_HOME}/Google/AndroidStudio2026.1.4/studio64.vmoptions"
fi
